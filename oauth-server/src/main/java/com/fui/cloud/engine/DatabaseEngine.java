...
public class DatabaseEngine {
    ...
    public void init() throws Exception {
        if (databaseSchemaUpdate) {
            ...
            runner.runScript(Resources.getResourceAsReader("sql/" + databaseType + "/oauth.sql"));
            runner.runScript(Resources.getResourceAsReader("sql/" + databaseType + "/oauth-data.sql"));
